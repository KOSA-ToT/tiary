						...
						<div class="col-6 col-12-medium">
							...
							<div class="box alt">
								<div class="row gtr-50 gtr-uniform">
									<div class="col-4"><span class="image fit"><img alt="" /></span></div>
									<div class="col-4"><span class="image fit"><img alt="" /></span></div>
									<div class="col-4"><span class="image fit"><img alt="" /></span></div>
									<!-- Break -->
									<div class="col-4"><span class="image fit"><img alt="" /></span></div>
							...
							<h4>Left &amp; Right</h4>
							<p><span class="image left"><img alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi,
								quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
							...
							<p><span class="image right"><img alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi,
								quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
								vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus.
								Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum
								ante ipsum primis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
			...
			<div class="inner">
				...
				<nav id="menu">
					...
					<ul>
						...
						<li><a href="generic.html">구독 목록</a></li>
						<li><a href="elements.html">내가 쓴 글</a></li>
