...
import com.example.tiary.article.service.impl.ArticleServiceImpl;
...
public class ArticleController {
	...
	public ResponseEntity patchArticle(@PathVariable("article-id") Long articleId,
		...
		return new ResponseEntity<>(
			articleService.updateArticle(user.getUsers().getId(), articleId, requestArticleDto,
				requestArticleDto.getStoreName()),
	...
	public ResponseEntity deleteArticle(@PathVariable("article-id") Long articleId,
		...
		return new ResponseEntity<>(articleService.deleteArticle(articleId, users.getUsers().getId()),
		HttpStatus.RESET_CONTENT);
	}
